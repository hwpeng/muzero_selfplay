...
from util import KnownBounds

class MuZeroConfig_TicTacToe:
    def __init__(self, network):
        ...
        self.known_bounds = KnownBounds(-1, 1)
        ...
        ### Network
        self.network = network  # "resnet" / "fullyconnected"
        ...
        self.window_size = self.replay_buffer_size
    ...
    def new_game(self):
      return Game('tictactoe', self.action_space_size, self.discount)

class MuZeroConfig_connect4:
    def __init__(self, network):
        # More information is available here: https://github.com/werner-duvaud/muzero-general/wiki/Hyperparameter-Optimization
    ...
    def new_game(self):
      return Game('connect4', self.action_space_size, self.discount)
